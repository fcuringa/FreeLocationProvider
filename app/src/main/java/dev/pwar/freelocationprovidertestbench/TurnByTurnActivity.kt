...
import dev.pwar.freelocationprovidermapbox.FreeLocationProviderMapboxEngine
...
class TurnByTurnActivity : AppCompatActivity() {
    ...
    private val locationObserver = object : LocationObserver {
        ...
        override fun onNewLocationMatcherResult(locationMatcherResult: LocationMatcherResult) {
            Log.d("onNewLocationMatcherResult", "Got $locationMatcherResult")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.mapView.getMapboxMap().loadStyleUri(NavigationStyles.NAVIGATION_NIGHT_STYLE) {
            ...
            val topLayer = it.styleLayers.last()
            pointAnnotationManager = binding.mapView.annotations.createPointAnnotationManager(
                AnnotationConfig(belowLayerId = topLayer.id)
            )
        }
