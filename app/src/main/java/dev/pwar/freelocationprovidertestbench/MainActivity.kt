        ...
        setContent {
            ...
            locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 500, 0.0f, object : LocationListener {
                override fun onLocationChanged(p0: Location) {
                    ...
                    if (!this@MainActivity::posAndroidMarker.isInitialized) {
                        ...
                        posAndroidMarker.icon = ContextCompat.getDrawable(this@MainActivity, R.drawable.baseline_place_24)
            ...
            fusedLocationClient.requestLocationUpdates(locRequest, object: LocationCallback() {
                override fun onLocationResult(p0: LocationResult) {
                    ...
                    if(!this@MainActivity::posGMSMarker.isInitialized) {
                        posGMSMarker = Marker(mapViewState).apply {
                            title = "GMS"
                            setAnchor(Marker.ANCHOR_CENTER, Marker.ANCHOR_BOTTOM)
                            icon = ContextCompat.getDrawable(this@MainActivity, R.drawable.baseline_blue_place_24)
                        }
